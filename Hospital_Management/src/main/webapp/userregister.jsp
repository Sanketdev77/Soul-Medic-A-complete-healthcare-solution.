			...
			<div class="form-holder">
				<div class="form-content">
					<div class="form-items">
						...
						<p>Be the Part of Soul Medic by registering yourself.</p>
						<form action="/userRegisterPage" class="requires-validation" novalidate method="post">
							...
							<div class="col-md-12">
								...
								<div class="invalid-feedback">Mobile Number field cannot be
									blank!</div>
							</div>
